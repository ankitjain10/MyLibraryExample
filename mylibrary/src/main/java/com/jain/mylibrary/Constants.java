...
public interface Constants {
    ...
    String PREFERENCE_NAME = "RIDE_AUTH_PREF";
    String RIDE_AUTH_SDK_API_KEY="RIDE_AUTH_SDK_API_KEY";

    String LABEL_ACCOUNT_ID = "RIDE_AUTH_SDK_ACCOUNT_ID";
    String LABEL_TOKEN = "RIDE_AUTH_SDK_TOKEN";
    String LABEL_NOTIFICATION_ICON = "RIDE_AUTH_SDK_NOTIFICATION_ICON";
    String LABEL_INAPP_EXCLUDE = "RIDE_AUTH_SDK_INAPP_EXCLUDE";
    String LABEL_REGION = "RIDE_AUTH_SDK_REGION";
    String LABEL_DISABLE_APP_LAUNCH = "RIDE_AUTH_SDK_DISABLE_APP_LAUNCHED";
    String LABEL_SSL_PINNING = "RIDE_AUTH_SDK_SSL_PINNING";
    String LABEL_BACKGROUND_SYNC = "RIDE_AUTH_SDK_BACKGROUND_SYNC";
    String LABEL_CUSTOM_ID = "RIDE_AUTH_SDK_USE_CUSTOM_ID";
    String LABEL_USE_GOOGLE_AD_ID = "RIDE_AUTH_SDK_USE_GOOGLE_AD_ID";
    String LABEL_FCM_SENDER_ID = "FCM_SENDER_ID";
    String LABEL_PACKAGE_NAME = "RIDE_AUTH_SDK_APP_PACKAGE";
    String LABEL_BETA = "RIDE_AUTH_SDK_BETA";
    String LABEL_INTENT_SERVICE = "RIDE_AUTH_SDK_INTENT_SERVICE";
    String LABEL_XIAOMI_APP_KEY = "RIDE_AUTH_SDK_XIAOMI_APP_KEY";
    String LABEL_XIAOMI_APP_ID = "RIDE_AUTH_SDK_XIAOMI_APP_ID";
    String CLEVERTAP_OPTOUT = "ct_optout";
    String CLEVERTAP_STORAGE_TAG = "WizRocket";
    String RIDE_AUTH_SDK_LOG_TAG = "RIDE_AUTH_SDK";
    ...
    String KEY_ENABLE_CUSTOM_CT_ID = "getEnableCustomRIDE_AUTH_SDKId";
    ...
    String RIDE_AUTH_SDK_IDENTIFIER = "RIDE_AUTH_SDK_IDENTIFIER";
