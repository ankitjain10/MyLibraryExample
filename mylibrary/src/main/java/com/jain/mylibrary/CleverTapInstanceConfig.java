...
public class CleverTapInstanceConfig implements Parcelable {
    ...
    private CleverTapInstanceConfig(Context context, String accountId, String accountToken, String accountRegion,
        ...
        this.debugLevel = MySDK.LogLevel.INFO.intValue();
...
//            }
    ...
    @SuppressWarnings({"unused"})
    public void setDebugLevel(MySDK.LogLevel debugLevel) {
    ...
    public void setIdentityKeys(@Constants.IdentityType String... identityKeys) {
        if (!isDefaultInstance) {
